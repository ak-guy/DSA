    ...
    def findMin(self, arr: List[int]) -> int:
        ...
        while l <= r:
            ...
            if arr[m] <= left_to_mid and arr[m] <= right_to_mid:  # 10, 0, 4
                ...
                arr[r] >= arr[m]
            ):  # here we cannot use arr[l] >= arr[m] condition because in already sorted array this condition will never be true so we would end up moving l to m+1 take example of [4,5,6,7,0,1,2]
                r = m - 1
            else:
                l = m + 1
