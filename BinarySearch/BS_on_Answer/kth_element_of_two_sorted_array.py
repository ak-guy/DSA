class Solution:
    def kthElement(self, arr1, arr2, n, m, k):
        ...
        l = max(
            0, k - m
        )  # this is the minimum no of elements we can pick from shorter array
        r = min(
            k, n
        )  # this is the maximum no of elements we can pick from shorter array
        ...
        while l <= r:
            ...
            if l1 <= r2 and l2 <= r1:  # we found answer
                ...
                l1 > r2
            ):  # this condition means there is bigger element present in left part of combined array
                r = mid_arr1 - 1
