...
class Solution:
    def getLongestPalindrome(
        self, s: str, starting_index: int, is_odd: bool, string_length: int
    ):
        ...
        return s[
            ind_1 + 1 : ind_1 + largest_palindrome_length + 1
        ], largest_palindrome_length
    ...
    def longestPalindrome(self, s: str) -> str:
        ...
        for i in range(n):
            ...
            res, res_length = self.getLongestPalindrome(
                s, starting_index=i, is_odd=True, string_length=n
            )
            ...
            res, res_length = self.getLongestPalindrome(
                s, starting_index=i, is_odd=False, string_length=n
            )
            if res_length > largest_palindrome_length:
                largest_palindrome_length = res_length
                ans = res
