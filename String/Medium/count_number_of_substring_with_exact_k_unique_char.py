class Solution:
    def getAtmostKUniqueCharSubstring(self, s, k):
        alpha = [0 for i in range(26)] # this will be the count of char occurrence in given string
        n = len(s)
        unique_chars = 0
        res = 0
        last = 0
        ...
        for ind in range(n):
            ...
            res += (ind - last + 1) # this is used to count number of substring having s[ind] in it
        return res
