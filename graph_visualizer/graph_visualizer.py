...
def print_graphical_tree(root):
    ...
    if root:
        ...
        add_edges(dot, root)
    dot.render(
        "tree", format="png", cleanup=True
    )  # This will create a PNG file named 'tree.png'
...
g = {
    ...
    25: [34, 88, 16, 3],
    26: [12, 6, 90],
    27: [20, 80, 45, 12, 24, 51, 97, 43],
    28: [6],
    29: [41, 72, 51, 94, 6, 81],
    30: [62, 90, 69],
    31: [44, 93],
    32: [],
    33: [83, 85, 46, 89, 95, 65, 57],
    34: [25, 40, 56],
    35: [90, 77, 73],
    36: [],
    37: [39, 48],
    ...
    75: [],
    76: [21],
    77: [35, 67, 22, 94, 64, 18],
    78: [],
    79: [69, 1, 41, 15, 83],
    80: [27, 61, 46],
    81: [29],
    82: [11, 54],
    83: [33, 24, 67, 39, 90, 79],
    84: [40, 4, 63],
    85: [44, 33, 50, 16, 90],
    86: [17],
    87: [70],
